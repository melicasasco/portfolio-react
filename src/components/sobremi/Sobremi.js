    ...
    return (
      ...
      className="a" id="sobremi">
        ...
        <motion.div 
          ...
          <p 
          className="a-desc">
          Soy una persona <span style={{color: 'rgb(105, 202, 202)'}}>organizada y con una gran motivación</span>, apasionada por el <b>diseño</b> y la <b>tecnología.</b>
          
          <br></br> Como egresada en Artes, <span style={{color: 'rgb(105, 202, 202)'}}>mi devoción por la pintura 
          y el diseño </span>me llevó a indagar sobre la materia en el ámbito digital. 
          
          <br></br>
          Actualmente me encuentro trabajando como Frontend Developer Jr en <a href='https://winguweb.org/' target='_blank' rel='noreferrer' style={{color: 'rgb(105, 202, 202)', textDecoration: 'none', fontWeight: '600'}}>Wingu</a> y en <a href='http://beinspiringtools.com/' target='_blank' rel='noreferrer' style={{color: 'rgb(105, 202, 202)', textDecoration: 'none', fontWeight: '600'}}>Be Inspiring Tools</a> brindando soporte web y de diseño.
